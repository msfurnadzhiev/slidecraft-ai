...
from src.schemas.analysis import ContentCategory
...
# Default values for the analyzer
DEFAULT_MAX_THEMES = 5
DEFAULT_RELATIONSHIP_THRESHOLD = 0.15
DEFAULT_KEY_PASSAGE_FRACTION = 0.4
DEFAULT_MAX_RELATIONSHIPS = 50

# Weights for key passage selection
KEY_PASSAGE_RETRIEVAL_WEIGHT = 0.6
KEY_PASSAGE_TOPIC_RELEVANCE_WEIGHT = 0.4