...
from src.agents.core import BaseLLMProcessor, AGENT_MODELS
...
class ContentGeneratorAgent(BaseLLMProcessor, name="content-generator"):
    ...
    def __init__(
        ...
        self._task = ContentGenerationTask(chat_model=self.chat_model)
